...
int Skill::getLevel(int whatSkill) const {
	/*
	switch (whatSkill) {
...
int Skill::getLevel_Max(int whatSkill) const {
	/*
	switch (whatSkill) {
...
string Skill::getName(int whatSkill) const {
	/*
...
string Skill::getDisc(int whatSkill) const {
	/*
	switch (whatSkill) {
...
int Skill::getType(int whatSkill) const {
	/*
	switch (whatSkill) {
...
int Skill::getNeedMP(int whatSkill) const {
	/*
	switch (whatSkill) {
...
double Skill::getAddAttack(int whatSkill) const {
	/*
	switch (whatSkill) {
...
int Skill::getRecoverHp(int whatSkill) const {
	/*
	switch (whatSkill) {
...
int Skill::getDebuff(int whatSkill) const {
	/*
	switch (whatSkill) {
